...
def _results_dir_default() -> Path:
    return _mainpap_root() / "results" / "R6P_v3"
...
class ModelConfig:
    ...
    max_offset_bins: float = 1.0
    dip_sigma_bins: float = 1.5
    dip_unet_depth: int = 2
    max_dip_count: int = 6
    count_adapter_hidden: int = 64
...
class LossConfig:
    ...
    mask_positive_weight: float = 24.0
...
class TrainConfig:
    ...
    checkpoint_filename: str = "r6p_v3_best.pt"
